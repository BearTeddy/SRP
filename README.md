...
### Implementation of SRP to be attempted in Flaskex (https://github.com/anfederico/flaskex)
 
This package provides a Javascript [Secure Remote Password](http://srp.stanford.edu/) [SRP-6](http://srp.stanford.edu/doc.html#papers) implementation for web browsers to perform a zero-knowledge proof-of-password to a web server.
...
## There is differences in hashing algorithm in pysrp and Thisbus. Below is one of the differences
